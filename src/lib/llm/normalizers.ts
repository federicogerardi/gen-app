...
export const metaAdsVariantSchema = z.object({
...
export const funnelOptinVariantSchema = z.object({
...
export const funnelOptinSchema = z.object({
...
export const funnelQuizSchema = z.object({
...
export function normalizeMarkdownWhitespace(value: string): string {
  return value
    .replace(/\r\n/g, '\n')
    .replace(/\u00a0/g, ' ')
    .replace(/\n{3,}/g, '\n\n')
...
export function toReadableJsonFallback(parsed: unknown): string | null {
...
export function formatMetaAdsOutput(parsed: unknown): string | null {
...
export function formatFunnelOptinOutput(parsed: unknown): string | null {
...
export function formatFunnelQuizOutput(parsed: unknown): string | null {
...
export function formatExtractionOutput(parsed: unknown): string | null {
...
export function extractWorkflowTypeFromInput(input: unknown): string | null {
