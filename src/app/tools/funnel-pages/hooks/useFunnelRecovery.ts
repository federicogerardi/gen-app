...
interface UseFunnelRecoveryOptions {
  projectId: string;
  ...
  replaceSteps: (steps: FunnelStepState[]) => void;
  setIntent: (value: FunnelIntent) => void;
}
...
export function useFunnelRecovery(options: UseFunnelRecoveryOptions) {
  const {
    projectId,
    setResumeNotice,
    setRetryNotice,
