...
import { NextLandSetupCard } from './components/NextLandSetupCard';
import { NextLandStatusQuick } from './components/NextLandStatusQuick';
import { NextLandStepCards } from './components/NextLandStepCards';
import { useNextLandGeneration } from './hooks/useNextLandGeneration';
import { useNextLandRecovery } from './hooks/useNextLandRecovery';
import { useNextLandExtraction } from './hooks/useNextLandExtraction';
import { useNextLandUiState } from './hooks/useNextLandUiState';
import type {
  NextLandIntent,
  Phase,
} from './types';
...
export function NextLandToolContent() {
  ...
  const {
    ...
    onRegenerateNextLand: handleRegenerateNextLand,
    onResetAll: resetAll,
