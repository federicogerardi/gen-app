...
CREATE TABLE "User" (
    ...
    "monthlyBudget" DECIMAL(65,30) NOT NULL DEFAULT 500.00,
    "monthlySpent" DECIMAL(65,30) NOT NULL DEFAULT 0.00,
...
-- AddForeignKey
ALTER TABLE "QuotaHistory" ADD CONSTRAINT "QuotaHistory_userId_fkey" FOREIGN KEY ("userId") REFERENCES "User"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
