...
1. **[tool-cloning-prerequisites.md](tool-cloning-prerequisites.md)** — Pre-requisiti, setup iniziale, accesso ai documenti di riferimento
2. **[tool-cloning-anatomy.md](tool-cloning-anatomy.md)** — File structure minima richiesta, naming conventions
3. **[tool-cloning-complexity-check.md](tool-cloning-complexity-check.md)** — Auto-classificazione tool tier (Simple/Moderate/Complex) e stima tempo
4. **[tool-cloning-phase-1-backend.md](tool-cloning-phase-1-backend.md)** — Phase 1: Route handler + Zod schema
5. **[tool-cloning-phase-2-prompts.md](tool-cloning-phase-2-prompts.md)** — Phase 2: Prompt builder + markdown sorgente
6. **[tool-cloning-phase-2-5-extraction.md](tool-cloning-phase-2-5-extraction.md)** — Phase 2.5 (opzionale): File upload + preprocessing
7. **[tool-cloning-phase-3-frontend.md](tool-cloning-phase-3-frontend.md)** — Phase 3: UI page, state management
8. **[tool-cloning-phase-3-5-ux-guide.md](tool-cloning-phase-3-5-ux-guide.md)** — Phase 3.5: UX replicability, user journey, interaction parity
9. **[tool-cloning-phase-3-6-checkpoint.md](tool-cloning-phase-3-6-checkpoint.md)** — Phase 3.6 (opzionale): Checkpoint & recovery
10. **[tool-cloning-phase-3-7-retry.md](tool-cloning-phase-3-7-retry.md)** — Phase 3.7 (opzionale): Retry con backoff
11. **[tool-cloning-testing-strategy.md](tool-cloning-testing-strategy.md)** — Testing: integration, unit, E2E
12. **[tool-cloning-conformity-checklist.md](tool-cloning-conformity-checklist.md)** — Checklist finale pre-PR, Definition of Done
13. **[tool-cloning-troubleshooting.md](tool-cloning-troubleshooting.md)** — FAQ comuni, error resolution
14. **[tool-cloning-go-no-go-assessment.md](tool-cloning-go-no-go-assessment.md)** — Framework validity analysis, applicability per complexity tier
...
**Tempo**: 6-8 ore  
**Path**: TUTTI i phase (1-4) + Phase 2.5, 3.5, 3.6, 3.7 + Advanced Testing → Conformity Checklist → GO/NO-GO Assessment
...
👉 Leggi **[tool-cloning-prerequisites.md](tool-cloning-prerequisites.md)** per iniziare.
