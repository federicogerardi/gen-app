...
| Task | Description | Completed | Date |
| -------- | ----------- | --------- | ---- |
| TASK-TRK-004 | Set Vercel Preview Build Command to npm run deploy:vercel. | In Progress | 2026-04-11 |
| TASK-TRK-005 | Set Vercel Production Build Command to npm run deploy:vercel. | In Progress | 2026-04-11 |
| TASK-TRK-006 | Verify both environments have correct DATABASE_URL scope values. |  |  |
| TASK-TRK-007 | Capture Vercel deploy log proof that prisma migrate deploy runs before build. | In Progress | 2026-04-11 |
...
| Task | Description | Completed | Date |
| -------- | ----------- | --------- | ---- |
| TASK-TRK-014 | Run dev deploy against empty Neon DB and verify table creation. |  |  |
| TASK-TRK-015 | Execute authentication smoke test after dev deploy. |  |  |
